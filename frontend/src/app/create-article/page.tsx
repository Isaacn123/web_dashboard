...
const DynamicCKEditor = dynamic(() => import('../components/ClientCKEditor'), {
  ssr: false,
});
...
const formattedData = {
    ...
    try {
      ...
      // const response = await fetch('http://45.56.120.65:8000/api/articles/', {45.56.120.65
